...
exports.run = async (client, message, args) => {
    ...
    if(!message.member.roles.cache.some(r => ["792512081899290627"].includes(r.id)) && (!message.member.hasPermission("ADMINISTRATOR")))
...
.setFooter(`Tap Ailesi`) // evet bilerek kaldırmadım ayriyetten sıfırdan yazdım :)
